...
export class Game {
    ...
    checkWin() {
        // Wybranie papieru
        if (this.playerChoice.classList.contains("game__paper") && this.computerChoice.classList.contains("game__rock")) {
            gameStats.playerWin()
        } else if (this.playerChoice.classList.contains("game__paper") && this.computerChoice.classList.contains("game__scissors")) {
            gameStats.playerLose()
        } else if (this.playerChoice.classList.contains("game__paper") && this.computerChoice.classList.contains("game__paper")) {
            gameStats.playerDraw()
        }

        // Wybranie kamienia
        if (this.playerChoice.classList.contains("game__rock") && this.computerChoice.classList.contains("game__scissors")) {
            gameStats.playerWin()
        } else if (this.playerChoice.classList.contains("game__rock") && this.computerChoice.classList.contains("game__paper")) {
            gameStats.playerLose()
        } else if (this.playerChoice.classList.contains("game__rock") && this.computerChoice.classList.contains("game__rock")) {
            gameStats.playerDraw()
        }


        // Wybranie nożyczek
        if (this.playerChoice.classList.contains("game__scissors") && this.computerChoice.classList.contains("game__paper")) {
            gameStats.playerWin()
        } else if (this.playerChoice.classList.contains("game__scissors") && this.computerChoice.classList.contains("game__rock")) {
            gameStats.playerLose()
        } else if (this.playerChoice.classList.contains("game__scissors") && this.computerChoice.classList.contains("game__scissors")) {
            gameStats.playerDraw()
        }
