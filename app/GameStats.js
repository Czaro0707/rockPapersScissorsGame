...
class GameStats {
    ...
    makeModalVisble() {
        ...
        PLAYERDESCRIPTION = document.querySelector(".game__button__playerDescription")
...
export const gameStats = new GameStats(document.querySelector(".board__result__score"), document.querySelector(".game__end"), document.querySelector(".game__end__description"), document.querySelector(".game__end__button"))